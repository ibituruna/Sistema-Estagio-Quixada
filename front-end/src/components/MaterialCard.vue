<template>
    <app-card v-bind="$attrs" class="v-card--material mt-4">
        <v-card-title class="align-start">
            <v-sheet :color="color" :width="fullHeader ? '100%' : undefined" max-width="100%" rounded
                class="overflow-hidden mt-n9 transition-swing v-card--material__sheet" elevation="6"
            >
